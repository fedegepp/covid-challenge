...
{
    public class CovidChallengeDbMigrationService : ITransientDependency
    {
        public ILogger<CovidChallengeDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<ICovidChallengeDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public CovidChallengeDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<ICovidChallengeDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<CovidChallengeDbMigrationService>.Instance;
        }
